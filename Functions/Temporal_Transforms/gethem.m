...
% GETHEM Calculates hemodynamics.
%
...
%   shallow measurements for each wavelength present. The result is
%   commonly referred to as the "hem" of a measurement set. If there is a
...
%% Make "hem" by averaging shallow measurments (i.e., nn1).
for k = 1:Nc
